...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg role="img" viewBox="0 0 24 24" className="fill-current" width="20" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    label: "GitHub",
    href: "https://github.com/DitaSukaTessia",
    icon: (
      <svg role="img" viewBox="0 0 24 24" className="fill-current" width="23" xmlns="http://www.w3.org/2000/svg">
        <title>GitHub</title>
